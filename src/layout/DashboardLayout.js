                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex-1">
                                    <ul className="pt-2 pb-4 space-y-1 text-sm">
                                        ...
                                        <li className="rounded-sm">
                                            <button rel="noopener noreferrer" to='' className="flex items-center p-2 space-x-3 rounded-md">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-400">
                            ...
                            <div className="flex items-center p-2 mt-12 space-x-4 justify-self-end">
                                ...
                                <div>
                                    ...
                                    <span className="flex items-center space-x-1">
                                        <Link rel="noopener noreferrer" to='' className="text-xs hover:underline text-gray-400">View profile</Link>
                                    </span>
                                </div>
                            </div>
                        </div>
